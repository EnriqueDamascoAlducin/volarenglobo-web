    ...
    "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre" ];
            ...
            function click_event(e){
                ...
                if(o.design_transitionDesc=='slide'){
                    ...
                    ,{queue:false, duration:settings_dzscalendar.animation_time/1.5, easing:settings_dzscalendar.animation_easing})
                    theControls.animate({'top' : skin_normalHeight + 20}
                    ,{queue:false, duration:settings_dzscalendar.animation_time/1.5, easing:settings_dzscalendar.animation_easing})
                    theMonths.animate({'top' : skin_normalHeight + 20}
                    ,{queue:false, duration:settings_dzscalendar.animation_time/1.5, easing:settings_dzscalendar.animation_easing})
            ...
            function gotoItem(arg1, arg2){
                ...
                if(o.start_weekday=='Sunday'){
                    aux = '<table class="argTable"><thead><tr><td>S</td><td>M</td><td>T</td><td>W</td><td>T</td><td>F</td><td>S</td></tr><tbody>'+auxMout+'</tbody></table>';
                }
                if(o.start_weekday=='Monday'){
                    aux = '<table class="argTable"><thead><tr><td>M</td><td>T</td><td>W</td><td>T</td><td>F</td><td>S</td><td>S</td></tr><tbody>'+auxMout+'</tbody></table>';
                }
