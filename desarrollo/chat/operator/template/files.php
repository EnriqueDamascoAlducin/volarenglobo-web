...
<section>
		...
		<div class="grid-m">
			...
			<td class="content-go"><a href="index.php?p=files&amp;sp=edit&amp;ssp=<?php echo $v["id"];?>" class="edit_user"><img src="<?php echo BASE_URL_ADMIN;?>img/edit.png" width="14" height="16" alt="edit" /></a></td>
			<td class="content-go"><a href="index.php?p=files&amp;sp=delete&amp;ssp=<?php echo $v["id"];?>"><img src="img/delete.png" width="14" height="16" alt="delete" onclick="if(!confirm('<?php echo $tl["error"]["e32"];?>'))return false;" /></a></td>
			</tr>
			<?php } ?>
			</table>
		...
		<div class="grid-s">
				...
				<div class="heading_solid">
				<h3><?php echo $tl["general"]["g50"];?></h3>
				</div>
				
				<?php if ($errors) { ?>
				<div class="status-failure"><?php echo $errors["e"].$errors["e1"].$errors["e2"];?></div>
				<?php } ?>
				
				<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
				<input name="uploadedfile" type="file" class="input_field submit inputbig"/>
				<label for="name"><?php echo $tl["general"]["g53"];?></label>
				<input type="text" name="name" class="inputbig">
				<label for="description"><?php echo $tl["general"]["g52"];?></label>
				<textarea name="description" class="input_field inputbig" cols="45" rows="7"></textarea>
