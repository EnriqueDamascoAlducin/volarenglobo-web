...
<tr>
	<td class="go"><h3><?php echo $tl["general"]["g53"];?></h3></td>
	<td><input type="text" name="name" class="inputbig<?php if ($errors["e1"]) { ?> error<?php } ?>" value="<?php echo $LS_FORM_DATA["name"];?>" /></td>
</tr>
<tr>
	<td class="go"><h3><?php echo $tl["general"]["g52"];?></h3></td>
	<td><textarea name="description" cols="60" rows="5" class="input_field"><?php echo $LS_FORM_DATA["description"];?></textarea></td>
</tr>
</table>
